  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="relative shrink-0" style={{ width: 100, height: 70 }}>
          <img
          ...
          <div
            className="fish-bob absolute"
            style={{ top: -3, left: 34, transform: 'rotate(-8deg)' }}
          >
            <div
        ...
        <div>
          ...
          <div className="font-heading font-bold leading-none" style={{ fontSize: 40 }}>
            {count}
          </div>
